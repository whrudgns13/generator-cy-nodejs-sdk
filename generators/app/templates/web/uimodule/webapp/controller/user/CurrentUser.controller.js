sap.ui.define([
    ...
    function (Controller, Fragment) {
        ...
        return Controller.extend("<%=ui5Namespace%>.<%=ui5ProjectName%>.controller.user.CurrentUser", {
            ...
            onOpenDialog: function () {
                ...
                if (!this.oDialog) {
                    this.oDialog = Fragment.load({
                        name: `<%=ui5Namespace%>.<%=ui5ProjectName%>.view.user.dialog.RoleCollectionsDialog`,
                        controller: this
                    })
                }
